    ...
    <form action="/category/edit" method="POST">
        ...
        @foreach ($auth as $a)
            <div class="mb-3">
                ...
                <input value="{{ $a->name }}" name="name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            <div class="mb-3 d-none">
                <label for="exampleInputEmail1" class="form-label">id</label>
                <input value="{{ $a->id }}" name="id" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
        @endforeach
        <div class="mb-3 d-none">
